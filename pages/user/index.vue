<template>
    <view style="height: 100%">
        ...
        <view class="flex items-center flex-col pingfang" style="margin-top: 70rpx">
            ...
            <view class="yu_e_card flex items-center justify-center">
        ...
        <view class="flex flex-col pingfang w-full" style="margin-top: 30rpx" @click.self="go_good">
            <view class="border rounded-xl mx-auto flex items-center" style="width: 80%; height: 150rpx; padding: 5px; padding-left: 20px">
        ...
        <view class="flex flex-col pingfang" style="margin-top: 30rpx" >
            <view class="border rounded-xl mx-auto flex items-center"  @click="go_dingdan()" style="width: 80%; height: 150rpx; padding: 5px; padding-left: 20px">
        ...
        </view><view class="flex flex-col pingfang" style="margin-top: 30rpx" >
            <view class="border rounded-xl mx-auto flex items-center"  @click="go_dingdan()" style="width: 80%; height: 150rpx; padding: 5px; padding-left: 20px">
                <image src="/static/images/icon/help.png" style="width: 38px; height: 38px"></image>
                <view style="padding-left: 20rpx">
      ...
      <view
          @click="logout"
          style="margin-bottom: 0px;border-radius: 9px;width: 20%;background: #007aff;height: 40px;color: white;text-align: center;margin-top: 20px" class="pingfang flex justify-center items-center mx-auto ">登出</view>
