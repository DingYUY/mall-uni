...
">
			<image :src="item.img[0]" style="width: 40%; object-fit: cover;" mode="aspectFill"></image>
			<view class="pingfang"
				...
				<view class="" style="padding: 10px;">
					...
					<view class="" v-if="item.status==3" style="font-size: 12px;margin-top: 20px;">订单状态:<span
							style="color: dimgray;">订单完成</span></view>
					<view class="" v-if="item.status==0" style="font-size: 12px;margin-top: 20px;">订单状态:<span
							style="color: dimgray;">未发货</span></view>
					<view class="" v-if="item.status==1" style="font-size: 12px;margin-top: 20px;">订单状态:<span
							style="color: dimgray;">发货中</span></view>
					<view style="margin-top: 20px;">￥{{item.amount}}</view>
				</view>
