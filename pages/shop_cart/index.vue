<template>
    <view style="height: 100%">
        <view class="flex p-2 justify-center items-center pingfang rounded-xl mx-auto" style="background: #3787ff; width: 80%; margin-top: 10rpx">
        ...
        <view class="flex shadow-xl p-2 mx-auto rounded-xl pingfang" v-show="item.show" style="background-color: white; width: 85%; margin-top: 10px;;justify-content: space-between" v-for="(item, index) in shop_cart" :key="index">
            ...
            <view class="flex item-end">
                <view @click="sub(index)" class="flex items-center justify-center p-1 rounded-xl" style="background-color: rgb(208, 209, 211); width: 40rpx">-</view>
                <view class="p-1 flex justify-center items-center" style="width: 40rpx">{{item.count}}</view>
                <view @click="add(index)" class="flex text-white items-center justify-center p-1 rounded-xl" style="background-color: rgb(29, 143, 236); width: 40rpx">+</view>
            </view>
        </view>

        <view class="fixed w-full bottom-'0' flex p-2 items-center justify-between pingfang" style="height: 110rpx; background-color: white; bottom: 131rpx">
