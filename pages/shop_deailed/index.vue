<template>
    <view style="height: 100%">
        <view class="absolute flex text-white items-center justify-between" style="z-index: 1; width: 100%; top: 69rpx">
            <image src="/static/images/icon/Iconly_Light_Arrow - Left.png" @tap="back" style="width: 32px; height: 36px; padding-left: 10px"></image>
            <image @click="joinCart" src="/static/images/icon/Path_false.png" style="width: 20px; height: 24px; padding: 30px"></image>
        </view>
        ...
        <view class="flex" style="justify-content: flex-end; padding: 10px">
            <view style="background-color: white; width: 60px; justify-content: space-around" class="border p-2 rounded-xl flex items-center pingfang">
...
<!--            <view class="shop_card">9成新</view>-->
<!--            <view class="shop_card">99成新</view>-->
<!--        </view>-->

<!--        <view class="pingfang" style="font-weight: 900; padding: 10px">颜色</view>-->

<!--        <view class="pingfang flex items-center">-->
<!--            <view class="shop_card">粉色</view>-->
<!--            <view class="shop_card">深空灰</view>-->
<!--            <view class="shop_card">紫色</view>-->
<!--        </view>-->
        ...
        <view
            @click="go_jiesuan"
            class="flex items-center justify-center rounded-xl text-white mx-auto"
      ...
      go_jiesuan(){
          ...
          if(token) {
            ...
            let arr=this.$data.list.map((item)=>{
              return {goods_id:item.good_id,count:item.count,price:item.price}
            })
